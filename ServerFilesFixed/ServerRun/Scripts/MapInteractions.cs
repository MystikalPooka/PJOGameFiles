	                ...
	                if (character.CharacterType == Enums.CharacterType.Recruit) {
	                    ...
	                    if (stepCounter % 5 == 0) {
	                        if (map.MapID == MapManager.GenerateMapID(737)) {
	                            ...
	                            if (!hasBeenWelcomed) {
	                                hitlist.AddPacketToMap(map, PacketBuilder.CreateChatMsg(((Recruit)character).Owner.Player.Name + " is new to PJO! Welcome!", Text.BrightGreen));
            ...
            try {
                switch (script) {
                    ...
                    case 13: {//for the Dive Whirlpool itself
                        ...
                        break;
                    case 14: {
                            Messenger.AskQuestion(client, "CliffsideTablet", "Will you take the Shining Star?", -1);
                        }
                        break;
                    case 15: {
                    ...
                    case 22: {
                            ...
                            if (surfSlot > -1) {
                                Messenger.AskQuestion(client, "Dig", "You can see something underground... Will you use dig?", -1);
                            }
