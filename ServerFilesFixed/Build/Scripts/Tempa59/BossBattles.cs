        ...
        public static void StartBossBattle(Client client, InstancedMap bossMap) {
            ...
            switch (bossMap.MapBase) {
                ...
                case 114: {//sour root mini
                    ...
                    break;
                case 115: {//alsil, flower field
                        //InstancedMap map = new InstancedMap(MapManager.GenerateMapID("i"));
                        //MapCloner.CloneMapTiles(MapManager.RetrieveMap(1225), map);
                        //MapCloner.CloneMapGeneralProperties(MapManager.RetrieveMap(1225), map);
                        //map.MapBase = 1225;
                        //Messenger.PlayerWarp(client, map, 8, 32);

                        StoryManager.PlayStory(client, 429);
                    }
                    break;
               ...
               case 1703: {//Sacred Tower, Aquatic Passage
               		...
               		break;
               case 389: {//Crystal Castle
               			StoryManager.PlayStory(client, 212);
               		}
               		break;
               case 1704: {//Sacred Tower, Frigid Passage
               ...
               case 1994: {//Boss Rush 1
               		...
               		break;
               case 1245: {//Mt. Nightmare
               			StoryManager.PlayStory(client, 9);
               		}
               		break;
               case 1990: {//Boss Rush 2
...
//                    break;
                ...
                case 1362: { // southern sea
                 ...
                 case 389: { // Crystal Castle
                        ...
                        //if (map.Name == "Crystal Castle") {
                        
                        map.SetTile(10, 13, 3725, 7, 1);
                        map.SetAttribute(10, 13, Enums.TileType.Blocked, 0, 0, 0, "", "", "");
                        Messenger.SendTile(10, 13, map);
...
//                    break;
                ...
                case 389: {//Crystal Castle
                        ...
                        map.SetTile(9, 1, 0, 0, 1);
                        map.SetAttribute(9, 1, Enums.TileType.Walkable, 0, 0, 0, "", "", "");
                        Messenger.SendTile(9, 1, map);
                        map.SetTile(10, 1, 0, 0, 1);
                        map.SetAttribute(10, 1, Enums.TileType.Walkable, 0, 0, 0, "", "", "");
                        Messenger.SendTile(10, 1, map);
                        map.SetTile(11, 1, 0, 0, 1);
                        map.SetAttribute(11, 1, Enums.TileType.Walkable, 0, 0, 0, "", "", "");
                        Messenger.SendTile(11, 1, map);
